                ...
                <div className="lg:w-3/4">
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3">
                            <Poster src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U2F0LCAzMSBKdWw%3D,ots-29,otc-FFFFFF,oy-612,ox-24/et00312759-pmmlmgcdws-portrait.jpg" title="Virtual Tour to HAMPI with Dr. Neelkanth Kote" subtitle="Antiques, Heritage, Museums | English | 10yrs + | 1hr 30mins" />
                        </div>
                        <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3">
                            <Poster src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U2F0LCAzMSBKdWw%3D,ots-29,otc-FFFFFF,oy-612,ox-24/et00312759-pmmlmgcdws-portrait.jpg" title="Virtual Tour to HAMPI with Dr. Neelkanth Kote" subtitle="Antiques, Heritage, Museums | English | 10yrs + | 1hr 30mins" />
                        </div>
