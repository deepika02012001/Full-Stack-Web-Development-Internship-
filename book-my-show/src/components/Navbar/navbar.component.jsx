...
const NavMd=()=>{
    return (
        <>
            <div className="w-full flex items-center gap-3 bg-white px-3 py-4 rounded-md">
                <BiSearch />
                <input type="search" className="w-full bg-transparent border-none focus:outline-none" placeholder="Search for Movies, Events Place, Sports and Activities" />
            </div>    
        </>
    );
};
        ...
        <>
            <div className="container mx-auto px-20 flex items-center justify-between">
                <div className="flex items-center gap-3 w-1/2">
                    ...
                    <div className="w-full flex items-center gap-3 bg-white px-2 py-2 rounded-md">
                        <BiSearch />
                        <input type="search" className="w-full bg-transparent border-none focus:outline-none" placeholder="Search for Movies, Events Place, Sports and Activities" />
                    </div>
                </div>
                <div className="flex items-center gap-4">
                <span className="text-gray-400 text-xm flex items-center cursor-pointer hover:text-white">
...
const Navbar=()=>{
    return <>
        <nav className="bg-navmobcolor-700 p-4">
