        ...
        <>
            <div className="hidden lg:flex gap-14 container px-24 mx-auto my-10">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg text-gray-700 font-semibold">Delivery</h3>
                </div>
                <div className="flex items-center gap-3">
                    <div className="w-16 h-16 bg-gray-100 p-4 rounded-full">
                    ...
                    <h3 className="text-lg text-gray-700 font-semibold">Dining Out</h3>
                </div>
                <div className="flex items-center gap-3">
                    <div className="w-16 h-16 bg-gray-100 p-4 rounded-full">
                    ...
                    <h3 className="text-lg text-gray-700 font-semibold">Nightlife</h3>
                </div>
                <div className="flex items-center gap-3">
                    <div className="w-16 h-16 bg-gray-100 p-4 rounded-full">
                    ...
                    <h3 className="text-lg text-gray-700 font-semibold">Nutrition</h3>
                </div>
            </div>
        </>
    );
